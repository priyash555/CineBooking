                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    <div class="accordion-body">
                                        <section>
                                                <div className='row '>
                                                    <div className='col-sm-6 text-start'>
                                                        <p>After selecting the movie and screening, you must select your ticket type.</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div className='col-sm-6 mb-2 text-end'>
                                            {ticketItem === "placeSection" ?
                                                <button className='btn btn-dark' data-bs-toggle="collapse" 
                                                    ...
                                                    onClick={() => {
                                                        if (chairNumber !== 0) {
                                                            toast.warning("Please select the same number of seats as your tickets!", {
                                                                theme: "dark",
                                                                position: "top-center"
                                                            })
                                                        } else {
                                        ...
                                        <div className='col-sm-12 col-md-6 mb-3'>
                                            ...
                                            <div className='row'>
                                                <div className='col-sm-6'>
                                                    <div class="form-floating mb-3">
                                                        <Cleave type="text" class="form-control" id="floatingCardLastDate" placeholder='Last Date' required
                                                        options={{date:true, datePattern: ['m','y']}} />
                                                        <label for="floatingCardLastDate">Last Date</label>
                                                    </div>
                                                </div>
                                                <div className='col-sm-6'>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control"  maxlength="3" size="3"  id="floatingSecurityNumber" placeholder="
Security Number" required/>
                                                        <label for="floatingSecurityNumber">CVV</label>
                                                    </div>
                                                </div>
                                                <p className='text-start'> <input class="form-check-input me-3" type="checkbox" value="" aria-label="Checkbox for following text input" required/>Conditions
                                                I have read and approve the Terms and Conditions.
                                            </p>
                                            </div>
                                        </div>
